...
import category1 from "../../assets/Design/kitchen.png";
import category2 from "../../assets/Design/bedroom.png";
import category3 from "../../assets/Design/wardrobe.png";
import category4 from "../../assets/Design/bathroom.png";
import category5 from "../../assets/Design/kids.png";
      ...
      <div className="max-w-[1920px] mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        >
          ...
          <div className={`flex flex-col border-l pl-4 transition-colors duration-500 ${isScrolled ? 'border-[#4a3f35]/30' : 'border-white/30'}`}>
            <span className="text-2xl font-bold tracking-[0.15em] font-serif leading-none" style={{ fontFamily: "'Cinzel', serif" }}>JC</span>
        ...
        {/* Mobile Menu Icon */}
        <button className={`md:hidden p-2 transition-colors duration-500 ${isScrolled ? 'text-[#4a3f35]' : 'text-white'}`}>
    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row gap-8 md:gap-16">
        ...
        <div className="md:w-2/3 text-gray-700 space-y-6 text-sm md:text-[0.95rem] leading-relaxed max-w-3xl">
          <p>
            At Nordform, we believe in the power of simplicity and functionality, inspired by the timeless elegance of Scandinavian design. Our furniture is crafted with the finest materials, offering a blend of minimalism and comfort to elevate every space. With a focus on clean lines, natural textures, and practical design, we create pieces that not only look beautiful but also stand the test of time.
          </p>
          <p>
            Rooted in the values of quality, sustainability, and innovation, Nordform brings the essence of Nordic living to your home. Whether you're furnishing a cozy apartment or a spacious living room, our carefully curated collection will transform your space into a sanctuary of style and serenity.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20 md:pb-32">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-[1px] bg-[#e3dfd3] border border-[#e3dfd3]">
          ...
          <div className="bg-[#fcfaf5] p-12 md:p-16 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white transition-colors duration-300">
            <img src={category1} alt="Kitchen" className="w-32 h-32 md:w-48 md:h-48 object-contain mix-blend-multiply mb-8 group-hover:scale-105 transition-transform duration-500" />
            <h3 className="text-sm md:text-base font-semibold text-[#4a3f35]">Kitchen</h3>
          </div>
          {/* Category 2 */}
          <div className="bg-[#fcfaf5] p-12 md:p-16 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white transition-colors duration-300">
            <img src={category2} alt="Bedroom" className="w-32 h-32 md:w-48 md:h-48 object-contain mix-blend-multiply mb-8 group-hover:scale-105 transition-transform duration-500" />
            <h3 className="text-sm md:text-base font-semibold text-[#4a3f35]">Bedroom</h3>
          </div>
          {/* Category 3 */}
          <div className="bg-[#fcfaf5] p-12 md:p-16 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white transition-colors duration-300">
            <img src={category3} alt="wardrobe" className="w-32 h-32 md:w-48 md:h-48 object-contain mix-blend-multiply mb-8 group-hover:scale-105 transition-transform duration-500" />
            <h3 className="text-sm md:text-base font-semibold text-[#4a3f35]">Wardrobe</h3>
          </div>
          {/* Category 4 */}
          <div className="bg-[#fcfaf5] p-12 md:p-16 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white transition-colors duration-300">
            <img src={category4} alt="Bathroom" className="w-32 h-32 md:w-48 md:h-48 object-contain mix-blend-multiply mb-8 group-hover:scale-105 transition-transform duration-500" />
            <h3 className="text-sm md:text-base font-semibold text-[#4a3f35]">Bathroom</h3>
          </div>
          {/* Category 5 */}
          <div className="bg-[#fcfaf5] p-12 md:p-16 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white transition-colors duration-300">
            <img src={category5} alt="Storage" className="w-32 h-32 md:w-48 md:h-48 object-contain mix-blend-multiply mb-8 group-hover:scale-105 transition-transform duration-500" />
            <h3 className="text-sm md:text-base font-semibold text-[#4a3f35]">Kids Bedroom</h3>
          </div>
          {/* Category 6 */}


          <div className="bg-[#fcfaf5] p-12 md:p-16 flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white transition-colors duration-300">
            <img src={category6} alt="Rugs" className="w-32 h-32 md:w-48 md:h-48 object-contain mix-blend-multiply mb-8 group-hover:scale-105 transition-transform duration-500" />
            <h3 className="text-sm md:text-base font-semibold text-[#4a3f35]">Rugs</h3>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20 md:pb-32">
        <h2 className="text-2xl font-bold text-[#4a3f35] mb-8 tracking-tight">More perspectives</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:h-[700px]">
          ...
          <div className="bg-[#a5b49a] p-8 md:p-10 flex flex-col h-[500px] lg:h-full overflow-hidden relative">
            <div className="z-10 text-[#2a3026] mb-8">
              <h3 className="text-2xl font-bold mb-4 leading-snug">Our Sustainable<br />Vision</h3>
              <p className="text-[0.85rem] leading-relaxed max-w-[280px]">
                At Nordform, we are committed to making thoughtful decisions that prioritize the wellbeing of people and the planet. From sourcing eco-conscious materials to ensuring responsible craftsmanship, sustainability is at the heart of everything we do.
              </p>
            </div>
            <div className="mt-auto -mx-8 -mb-10 relative h-[50%] lg:h-[45%] flex-grow">
              <img src={card1} alt="Sustainable Sofa" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col h-[600px] lg:h-full gap-6">
            <div className="h-1/2 relative bg-gray-200">
              <img src={card2} alt="Timeless Elegance" className="absolute inset-0 w-full h-full object-cover" />
            </div>
            <div className="bg-[#f0e3bc] p-8 md:p-10 h-1/2 flex flex-col justify-center text-[#4a3f35]">
              <h3 className="text-2xl font-bold mb-4 leading-snug">Looking for<br />Timeless Elegance?</h3>
              <p className="text-[0.85rem] leading-relaxed max-w-[280px]">
          ...
          <div className="bg-[#e2a893] p-8 md:p-10 flex flex-col h-[550px] lg:h-full overflow-hidden relative">
            <div className="z-10 text-[#4a2e24] mb-8">
              <h3 className="text-2xl font-bold mb-4 leading-snug">Spare Parts</h3>
              <p className="text-[0.85rem] leading-relaxed max-w-[280px]">
                At Nordform, we believe in the longevity of design. That's why we offer spare parts for selected items to ensure your furniture remains functional and timeless. For assistance or purchases, reach out to us at customercare@nordform.com. Please note: Buyer assembly limits warranty to components only.
              </p>
            </div>
            <div className="mt-auto -mx-8 -mb-10 relative h-[45%] lg:h-[40%] flex-grow">
              <img src={card3} alt="Spare Parts" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
