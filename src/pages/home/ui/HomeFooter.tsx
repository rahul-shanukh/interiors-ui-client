...
export const HomeFooter = ({ theme = "default" }: { theme?: "default" | "about" }) => {
  ...
  return (
    <footer className={`relative pt-24 font-sans overflow-hidden ${
      theme === "about"
      ...
      {theme === "about" && (
        <>
          <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#C5A059]/5 blur-[120px] rounded-full"></div>
          <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-[#4a3f35]/5 blur-[120px] rounded-full"></div>
        </>
      )}

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        {/* CTA Banner - Hidden on About page to prevent duplicating CTA section */}
        {theme !== "about" && (
          <div
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div className="col-span-2">
            <div className="mb-6">
              ...
              <span className={`block text-[0.65rem] tracking-[0.35em] uppercase ${
            ...
            <div className="flex gap-4">
              <a
                ...
                bg-white shadow-md hover:-translate-y-1 transition-all duration-300 ${
                  theme === "about" ? "hover:shadow-[#C5A059]/20" : "hover:shadow-indigo-200"
                }`}
              >
              ...
              <a
                ...
                className={`w-11 h-11 rounded-xl flex items-center justify-center
                bg-white shadow-md hover:-translate-y-1 transition-all duration-300 ${
                  theme === "about" ? "hover:shadow-[#C5A059]/20" : "hover:shadow-pink-200"
                }`}
              >
              ...
              <a
                ...
                className={`w-11 h-11 rounded-xl flex items-center justify-center
                bg-white shadow-md hover:-translate-y-1 transition-all duration-300 ${
                  theme === "about" ? "hover:shadow-[#C5A059]/20" : "hover:shadow-blue-200"
                }`}
              >
              ...
              <a
                ...
                className={`w-11 h-11 rounded-xl flex items-center justify-center
                bg-white shadow-md hover:-translate-y-1 transition-all duration-300 ${
                  theme === "about" ? "hover:shadow-[#C5A059]/20" : "hover:shadow-green-200"
                }`}
              >
              ...
              <ul className="space-y-4">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className={`text-sm hover:translate-x-1 transition-all duration-200 ${
                        theme === "about" 
        ...
        <div
          className={`border-t py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs tracking-wider ${
            theme === "about" ? "border-[#4a3f35]/10 text-[#4a3f35]/60" : "border-gray-200 text-gray-500"
          }`}
        >
          ...
          <div className="flex gap-8">
            <span className={`cursor-pointer ${
              theme === "about" ? "hover:text-[#C5A059]" : "hover:text-indigo-500"
            }`}>
              Warangal
            </span>
