...
import consultImage from "../../../../assets/about/hero_living_room.avif";
    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 left-3 bg-[#1E150F]/85 backdrop-blur-xs border border-white/20 px-2 py-1 text-[7px] text-white font-mono rounded-xs z-30 pointer-events-none select-none flex flex-col gap-0.5">
          ...
          <div>
            [GRID_LOC: X:
            {(coords.xRel >= 0 ? "+" : "") + coords.xRel.toFixed(2)} Y:
            {(coords.yRel >= 0 ? "+" : "") + coords.yRel.toFixed(2)}]
          </div>
          <div>
            [TILT: RX:{coords.rx.toFixed(1)}° RY:{coords.ry.toFixed(1)}°]
          </div>
        </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`md:hidden absolute top-full left-0 w-full bg-[#fdfbf7] shadow-xl transition-all duration-300 overflow-hidden ${
            isMobileMenuOpen
              ? "max-h-[60vh] border-t border-[#4a3f35]/10"
              : "max-h-0"
          }`}
        >
      ...
      <section className="py-24 px-6 md:px-12 bg-[#fdfbf7] text-center relative overflow-hidden border-b border-[#13503B]/5">
        ...
        >
          ...
          <div className="overflow-hidden py-1">
            ...
            >
              “We believe your space should be a reflection of your finest
              tastes—blending sophisticated{" "}
              <span className="text-[#C5A059] font-normal not-italic">
                Scandinavian minimalism
              </span>{" "}
              with rich,{" "}
              <span className="text-[#C5A059] font-normal not-italic">
                emerald-hued opulence
              </span>
              .”
            </motion.p>
          </div>
      ...
      <section className="py-32 px-6 md:px-12 bg-gradient-to-br from-[#B38F4D] via-[#C5A059] to-[#997632] text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none opacity-10 overflow-hidden text-white">
          <svg
            className="absolute -top-10 left-[10%] w-96 h-96 text-white"
            viewBox="0 0 100 100"
            fill="none"
            stroke="currentColor"
            strokeWidth="0.15"
          ...
          <svg
            className="absolute bottom-5 right-[8%] w-80 h-80 text-white rotate-45"
            viewBox="0 0 100 100"
            fill="none"
            stroke="currentColor"
            strokeWidth="0.15"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
          ...
          >
            ...
            >
              <span className="absolute -top-8 -left-3 text-white/15 text-[9rem] font-serif leading-none select-none pointer-events-none">
                “
              </span>
              <p
              ...
              >
                A space should not just look beautiful; it should feel like a
                whisper of luxury and a physical sigh of relief.
              </p>
            </motion.div>
            ...
            <div className="space-y-6 text-white/80 font-light text-sm md:text-base leading-relaxed max-w-2xl">
              ...
              >
                Ananya founded East Interia to redefine the boundaries of
                bespoke luxury living. Holding a Master’s in Architecture &
                Design from Stockholm, she merges clean Scandinavian
                functionality with the dramatic, warm textures of classical
                Indian heritage.
              </motion.p>
              <motion.p
                variants={{
              ...
              >
                Under her creative direction, the studio approaches interior
                design as a form of high art—where spatial choreography,
                material authenticity, and tailored lighting converge to elevate
                daily living into a sensory experience.
              </motion.p>
            </div>
            ...
            >
              <div className="flex flex-col">
                <span
                  className="text-[0.65rem] text-white/80 uppercase tracking-[0.3em] font-semibold"
                  style={{ fontFamily: "'Cinzel', serif" }}
                >
                  Bespoke Creations
                </span>
              ...
              <div className="flex flex-col items-end">
                <svg
                  className="h-12 w-40 text-white opacity-90 transition-opacity duration-500 hover:opacity-100"
                  viewBox="0 0 200 60"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.5"
            ...
            {[
              {
                ...
                description:
                  "We begin by understanding your lifestyle, preferences, and the inherent character of your space. This deep-dive ensures our concepts align perfectly with your daily life.",
                icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
              },
              {
                title: "2. Design & Curation",
                description:
                  "Our team develops intricate 3D models, selects premium materials, and curates bespoke furnishings to craft a cohesive, luxurious aesthetic tailored just for you.",
                icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",
              },
              {
                title: "3. Execution & Delivery",
                description:
                  "From procurement to final installation, our project managers oversee every detail, ensuring a seamless transformation and an immaculate final reveal.",
                icon: "M5 13l4 4L19 7",
              },
            ].map((step, idx) => (
              <motion.div
              ...
              >
                <div className="w-14 h-14 bg-[#C5A059]/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-[#C5A059] transition-colors duration-500">
                  <svg
                    className="w-6 h-6 text-[#C5A059] group-hover:text-white transition-colors duration-500"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <h3
                  className="text-xl font-bold text-[#A37E3A] mb-4"
                  style={{ fontFamily: "'Cinzel', serif" }}
                >
                  {step.title}
                </h3>
