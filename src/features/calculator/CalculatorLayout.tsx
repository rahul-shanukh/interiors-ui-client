        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div
              ...
              onKeyDown={(e) => e.key === 'Enter' && navigate("/#price-calculators")}
            >
              <span className="font-serif text-xl sm:text-2xl font-black tracking-tight text-[#13503B] flex flex-wrap items-center justify-center sm:justify-start gap-2 block">
                JC Interiors
