...
import { CheckCircle2, ChevronRight, Calculator, Sparkles, User, Phone, Mail, MapPin, Search, ChevronDown, Loader2, X, Star, Settings, Shield, Award, Edit2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#fcfbf9] py-2 sm:py-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-center font-sans">
      <div className="max-w-3xl w-full mx-auto bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.05)] overflow-hidden border border-gray-100 flex flex-col min-h-[600px]">
        ...
        {/* Footer Navigation Buttons (Hidden on Intro, summary, quote and results) */}
        {currentStep > 0 && currentStep < 7 && (
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-100 flex justify-between items-center mt-auto">
            <button
              onClick={handleBack}
              className="text-gray-400 font-bold tracking-widest text-xs hover:text-[#13503B] transition-colors uppercase cursor-pointer"
            >
              ← GO BACK
            </button>
            ...
            <button
              onClick={handleNext}
              className="group flex items-center gap-2 bg-[#13503B] text-white px-8 py-4 rounded-full font-bold tracking-widest text-xs transition-all hover:bg-[#0d3528] shadow-xl shadow-[#13503B]/20 cursor-pointer"
            >
              CONTINUE
