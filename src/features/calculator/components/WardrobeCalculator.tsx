...
const TYPES = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1558882224-cca166733360?q=80&w=600&auto=format&fit=crop",
  },
];
...
const MATERIALS = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1507398941214-572c25f4b1bc?q=80&w=600&auto=format&fit=crop",
  },
];
...
const calculateFallbackPrice = (selections: {
  ...
  const accPrice = selections.accessories.reduce(
    (sum, item) => sum + (ACCESSORY_PRICES[item] || 0),
    0,
  );
        ...
        <div className="flex-1 p-8 sm:p-10 flex flex-col justify-center">
          ...
          {currentStep === 0 && (
            <div className="animate-fadeIn text-center">
              ...
              <h2 className="text-3xl font-serif text-[#13503B] font-bold mt-2 mb-4">
                What is your wardrobe length?
              </h2>
              <p className="text-gray-400 text-sm mb-8">
                Select the outer length (horizontal width) of your cabinet
                layout.
              </p>
          ...
          {currentStep === 1 && (
            <div className="animate-fadeIn text-center">
              ...
              <h2 className="text-3xl font-serif text-[#13503B] font-bold mt-2 mb-4">
                What is your wardrobe height?
              </h2>
              <p className="text-gray-400 text-sm mb-8">
                Select the height of your wardrobe cabinet layout.
              </p>
              ...
              <div className="space-y-3 mb-8">
                {FINISHES.map((f) => (
                  ...
                  >
                    ...
                    />
                    <div>
                      <span className="font-bold text-gray-800 block text-sm sm:text-base">
                        {f.name}
                      </span>
                  ...
                  <div className="flex justify-between py-2 text-xs">
                    ...
                    <span className="font-bold text-gray-800">
                      ...
                      {new Intl.NumberFormat("en-IN", {
                        ...
                        currency: "INR",
                        maximumFractionDigits: 0,
                      }).format(priceBreakdown.material)}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 text-xs">
                    <span className="text-gray-400 uppercase tracking-wider font-semibold">
                    ...
                    <span className="font-bold text-gray-800">
                      ...
                      {new Intl.NumberFormat("en-IN", {
                        ...
                        currency: "INR",
                        maximumFractionDigits: 0,
                      }).format(priceBreakdown.finish)}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 text-xs">
                    <span className="text-gray-400 uppercase tracking-wider font-semibold">
                      Accessories Surcharge
                    </span>
                    <span className="font-bold text-gray-800">
                      +
                      {new Intl.NumberFormat("en-IN", {
                        ...
                        currency: "INR",
                        maximumFractionDigits: 0,
                      }).format(priceBreakdown.accessories)}
                    </span>
                  </div>
